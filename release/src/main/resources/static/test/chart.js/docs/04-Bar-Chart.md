...
*Options for xAxes* | | |
type | String | "Category" | As defined in [Scales](#scales-categoryRoom-scale).
...
barPercentage | Number | 0.9 | Percent (0-1) of the available width each bar should be within the categoryRoom percentage. 1.0 will take the whole categoryRoom width and put the bars right next to each other. [Read More](#bar-chart-barpercentage-vs-categorypercentage)
...
The following shows the relationship between the bar percentage option and the categoryRoom percentage option.
